...
WebUI.click(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/a_Enter the Store'))

WebUI.click(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/a_Sign In'))

WebUI.click(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/a_Register Now'))

WebUI.setText(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_User ID_username'), '12345')

WebUI.verifyElementVisible(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_User ID_username'))
String userID = WebUI.getAttribute(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_User ID_username'), 'value')
assert userID == '12345' : "Expect userID is 12345, but found '${userID}'"

WebUI.setText(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_New password_password'), '12345')

WebUI.verifyElementVisible(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_New password_password'))
String password = WebUI.getAttribute(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_New password_password'), 'value')
assert password == '12345' : "Expect password is 12345, but found '${password}'"

WebUI.setText(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_Repeat password_repeatedPassword'), '12345')

WebUI.verifyElementVisible(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_Repeat password_repeatedPassword'))
String repeat_password = WebUI.getAttribute(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_Repeat password_repeatedPassword'), 'value')
assert repeat_password == '12345' : "Expect password is 12345, but found '${repeat_password}'"

WebUI.setText(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_First name_account.firstName'), 'hi')

WebUI.verifyElementVisible(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_First name_account.firstName'))
String firstname = WebUI.getAttribute(findTestObject('Object Repository/Sign Up/Sign up with numeric userID/input_First name_account.firstName'), 'value')
